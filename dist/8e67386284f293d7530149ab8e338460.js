...
const message = exports.message = 'Hello, Parcel!';
},{}],2:[function(require,module,exports) {
"use strict";

var _message = require("./message");

document.body.innerText = `message: ${_message.message}`;
},{"./message":3}],0:[function(require,module,exports) {
...
if (!module.bundle.parent) {
  var ws = new WebSocket('ws://localhost:57111/');
  ws.onmessage = (e) => {
